/*
 * Copyright (c) 2023 Drogobo (Luke)
 * millaq died in a car accident (or something) so I am continuing this project
 *
...
int main(int argc, const char* argv[]) {
    ...
    printf("Initialization complete - blocking new mouse paste actions\n");
    ev_run(evloop, 0);
